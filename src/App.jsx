...
const T = {
  ...
  accent:       "#0ecb81",
  accentGrad:   "linear-gradient(180deg, #1fffa0 0%, #0ecb81 60%, #0aaf6e 100%)",
      ...
      <div data-sheet-scroll style={{flex:1,overflowY:"auto",WebkitOverflowScrolling:"touch",overscrollBehavior:"none",padding:"8px 20px calc(40px + env(safe-area-inset-bottom, 0px))"}}>
        ...
        {optResult&&!applied&&(optResult.score5yAfter-optResult.score5yBefore<0.5?(
          ...
          <div style={{marginTop:8}}>
            ...
            {/* CTA */}
            <button onClick={()=>setShowConfirm(true)} className="btn-primary" style={{width:"100%",background:"radial-gradient(ellipse at 50% 40%, #2dffa0 0%, #0ecb81 45%, #0aab6a 100%)",border:"none",borderRadius:14,padding:"14px",color:"#000",fontSize:14,fontWeight:700,cursor:"pointer",fontFamily:T.fontDisplay}}>
              ...
              <div onClick={()=>setShowConfirm(false)} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:999999,padding:"0 24px"}}>
                <div onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:380,background:T.bgElevated,border:`0.5px solid ${T.border}`,borderRadius:20,padding:"28px 24px",animation:"popIn .25s cubic-bezier(.16,1,.3,1)"}}>
                  ...
                  <div style={{display:"flex",flexDirection:"column",gap:8}}>
                    ...
                    }} className="btn-primary" style={{width:"100%",background:"radial-gradient(ellipse at 50% 40%, #2dffa0 0%, #0ecb81 45%, #0aab6a 100%)",border:"none",borderRadius:12,padding:"14px",color:"#000",fontSize:14,fontWeight:700,cursor:"pointer",fontFamily:T.fontDisplay}}>
  ...
  return(
    <div ref={ref} style={{display:"flex",flexDirection:"column",gap:10}}>
      ...
      <div style={{display:"flex",gap:10}}>
        ...
        <button onClick={doAdd} className="btn-primary" style={{background:"radial-gradient(ellipse at 50% 40%, #2dffa0 0%, #0ecb81 45%, #0aab6a 100%)",border:"none",borderRadius:14,padding:"14px 22px",color:"#000",fontSize:18,fontWeight:800,cursor:"pointer",flexShrink:0,fontFamily:T.fontDisplay,transition:"opacity .15s"}}
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.9)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:99999,padding:"20px 16px"}}>
      <Glass style={{padding:"32px 24px",width:"100%",maxWidth:400}}>
        ...
        <button onClick={onAccept} className="btn-primary" style={{width:"100%",background:"radial-gradient(ellipse at 50% 40%, #2dffa0 0%, #0ecb81 45%, #0aab6a 100%)",border:"none",borderRadius:14,padding:"16px",color:"#000",fontSize:15,fontWeight:800,cursor:"pointer",fontFamily:T.fontDisplay,letterSpacing:.3,transition:"opacity .15s"}}
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,zIndex:10}}>
        ...
        <div style={{background:T.bg,padding:"4px 24px 40px"}}>
          ...
          {step<2?(
            ...
            <button onClick={done}
              className={added.length>0?"btn-primary":""} style={{width:"100%",background:added.length>0?"radial-gradient(ellipse at 50% 40%, #2dffa0 0%, #0ecb81 45%, #0aab6a 100%)":T.surfaceMed,border:added.length>0?"none":`0.5px solid ${T.border}`,borderRadius:16,padding:"17px",color:added.length>0?"#000":T.text4,fontSize:15,fontWeight:700,cursor:"pointer",letterSpacing:.2,transition:"all .2s"}}
...
export default function App(){
  ...
  accentGrad:   "linear-gradient(180deg, #1fffa0 0%, #0ecb81 60%, #0aaf6e 100%)",o, useRef, useEffect, useCallback } from "react";
import { createPortal } from "react-dom";
