...
function computeScores(holdings){
  ...
  const total=holdings.reduce((s,h)=>s+h.amount,0)+planTotal;if(!total)return{total:0,geo:0,sector:0,overlap:0,assetClass:0,currency:0,geoMap:{},secMap:{},classes:{},currencies:{}};
