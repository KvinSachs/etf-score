      ...
      <div data-sheet-scroll style={{flex:1,overflowY:"auto",WebkitOverflowScrolling:"touch",overscrollBehavior:"none",padding:"8px 20px calc(40px + env(safe-area-inset-bottom, 0px))"}}>
        ...
        {optResult&&!applied&&(()=>{
          ...
          <div style={{marginTop:8}}>
            ...
            {/* Score comparison */}
            <div style={{display:"flex",gap:8,marginBottom:16}}>              <div style={{flex:1,background:T.surfaceFaint,border:`0.5px solid ${T.borderSubtle}`,borderRadius:12,padding:"12px",textAlign:"center"}}>
