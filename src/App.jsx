...
function buildRecs(scores,holdings,total){
  ...
  if(bondPct===0&&holdings.length>0)recs.push({priority:"high",level:"essential",color:"#ff4d4d",bg:"rgba(255,77,77,0.06)",border:"rgba(255,77,77,0.15)",cat:"bonds",title:"Aucune obligation",text:"Portefeuille 100% actions. Des ETF obligataires réduiraient significativement la volatilité lors des krachs."});
